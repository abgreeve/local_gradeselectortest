...
namespace local_gradeselectortest\external;
 ...
 *
 * @package    local_gradeselectortest
...
class itemlist extends external_api {
     ...
     */
    public static function get_items(int $courseid): array {
        ...
        $url = new moodle_url('/local/gradeselectortest/selectortest.php', ['id' => $courseid]);
        $items = [
            [
                'id' => 1,
                'url' => $url,
        ...
        return new external_single_structure([
            'items' => new external_multiple_structure(
                new external_single_structure([
                    'id'    => new external_value(PARAM_INT, 'ID of the item', VALUE_OPTIONAL),

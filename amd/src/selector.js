 ...
 */
export const init = () => {
    window.console.log('select init');
...
const registerListenerEvents = () => {
    ...
    let dropdownmenuselector = '.search-widget[data-searchtype="local_gradeselectortest-item"] .dropdown-menu';
    let dropdownselector = '.search-widget[data-searchtype="local_gradeselectortest-item"]';
    ...
    $(dropdownselector).on('show.bs.dropdown', async(e) => {
        ...
        bodyPromiseResolver(Templates.render('local_gradeselectortest/selectorbody', []));
    });
...
const swapitemFetch = (courseid) => {
    const request = {
        methodname: 'local_gradeselectortest_get_items',
        args: {
            courseid: courseid,
        },
    };
